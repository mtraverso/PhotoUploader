...
public class OAuth2Auth {
     ...
     */
    private static final String APPLICATION_NAME = "PhotoUploader/1.0";
    ...
    public static Credential authorize() throws Exception {
        ...
        clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
                new InputStreamReader(OAuth2Auth.class.getResourceAsStream("client_secret_355432543484-8gtv06ap8bc2glfrr2r681h48mmjeghn.apps.googleusercontent.com.json")));
        if (clientSecrets.getDetails().getClientId().startsWith("adas")
                || clientSecrets.getDetails().getClientSecret().startsWith("asdasd-zR6n0rQCA20irv")) {
